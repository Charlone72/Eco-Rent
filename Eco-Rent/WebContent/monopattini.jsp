  ...
  <body>
    ...
    <div id="wrap">
      ...
      <jsp:include page='navigation.jsp'>
        <jsp:param name="param" value="monopattini"/>
      </jsp:include>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-3 mx-auto">
              <div class="text-center">
                <h2><fmt:message key="monopattini.title" /></h2>
              </div>
          </div>
        </div>
        ...
        <div class="row">
              ...
              <div class="col-md-4 col-sm-4 mb-4">
                <img src="pictures/segwayEScooter.png" style="height:200px;" class="img-responsive center-block" /></a>
              </div>
              <div class="col-md-4 col-sm-4 mb-4">
                <h3><a href="Controller?Command=viewList&cat=2"><fmt:message key="monopattini.row0.title" /></a></h3>
                <div style="font-size:12px; color:#03225C;"><fmt:message key="monopattini.row0.body" /></div>
              </div>
              <div class="col-md-2 col-sm-4 mb-4">
