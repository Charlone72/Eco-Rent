      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-4 col-sm-offset-4">
            <h3><fmt:message key="forgotPassword.title" /></h3>
            <p><c:out value="${msg1}"/></p>
            <p><c:out value="${msg2}"/></p>

            <div class="row spacer2"></div>

            <FORM name="myForm" action="/ecorent/Controller" method="get">
              <INPUT type="hidden" name="Command" value="sendPassword">

              <div class="form-group">
                <label for="InputEmail1"><fmt:message key="login.email" /></label>
                <input type="email" class="form-control" id="InputEmail1" placeholder="Insert E-mail here" name="email" required>
              </div>

              <div class="form-group">
                <input class="btn btn-primary" type="submit" value="<fmt:message key="forgotPassword.btn" />">
                <!--  <button class="btn btn-lg btn-primary btn-block" type="submit"><fmt:message key="forgotPassword.btn" /></button>-->
              </div>
