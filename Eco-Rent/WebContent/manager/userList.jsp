...
<head>
    ...
    <title>Eco-Rent - Lista Utenti</title>
    ...
    <script language="JavaScript">
      ...
      function submitForm(value, name) {
          ...
          document.myForm.email.value = name;
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Lista Utenti</h2>
                    </div>
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${users}">
                                        <tr>
                                          ...
                                          <td><c:out value='${myFunc:showString(row.email, 15)}' escapeXml="false" /></td>
                                          <td><c:out value="${row.cap}"/></td>
                                          <td><c:out value='${myFunc:showString(row.via, 15)}' escapeXml="false" /></td>
                                          <td><c:out value="${row.domicilio}"/></td>
                                          <td><c:out value="${row.telefono}"/></td>
                                          <td><c:out value="${row.enabled}"/></td>
                                          <!-- <td>
                                            <button type="button" class="btn btn-danger" name="deleteUser" onclick="javascript:submitForm('deleteUser', '<c:out value="${row.email}"/>');">
                                              Elimina
                                            </button>
                                          </td>
                                          <td>
                                            <button type="button" class="btn btn-success" name="updateUser" onclick="javascript:submitForm('updateUser', '<c:out value="${row.email}"/>');">
                                              Aggiorna
                                            </button>
                                          </td> -->
                                          <td>
                                            <div class="dropdown">
                                              ...
                                              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li><a href="javascript:submitForm('updateUser', '<c:out value="${row.email}"/>');" class="dropdown-item">Aggiorna utente</a></li>
                                                <li role="separator" class="divider"></li>
                                                <li><a href="javascript:submitForm('userReservations', '<c:out value="${row.email}"/>');" class="dropdown-item">Riservazioni utente</a></li>
                                                <li><a href="javascript:submitForm('deleteUser', '<c:out value="${row.email}"/>');" class="dropdown-item">Elimina utente</a></li>
                                              </ul>
                                            </div>
                                          </td>
                                        </tr>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      <div class="my-2"></div>
                      <a href="javascript:submitFormMenu('newUser')" class="btn btn-success btn-icon-split">
