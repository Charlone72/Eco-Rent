        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Lista Manager</h2>
                    </div>
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${managers}">
                                        <tr>
                                          ...
                                          <td><c:out value="${row.diritti}"/></td>
                                          <td><c:out value='${myFunc:showString(row.email, 23)}' escapeXml="false" /></td>
                                          <td><c:out value="${row.infoPre}"/></td>
                                          <td>
                                            <button type="button" class="btn btn-danger" name="deleteManager" onclick="javascript:submitForm('deleteManager', '<c:out value="${row.nome}"/>');">
                                              Elimina
                                            </button>
                                          </td>
                                          <td>
                                            <button type="button" class="btn btn-success" name="updateManager" onclick="javascript:submitForm('viewUpdateManager', '<c:out value="${row.nome}"/>');">
                                              Aggiorna
                                            </button>
                                          </td>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      <div class="my-2"></div>
                      <a href="javascript:submitFormMenu('viewInsertManager')" class="btn btn-success btn-icon-split">
