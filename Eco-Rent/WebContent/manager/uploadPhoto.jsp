...
<head>
    ...
    <title>Eco-Rent - upload foto</title>
    ...
    <script language="JavaScript">
      ...
      function controlTextField(form) {
        ...
        if(form.descrizione.value == ""){
          alert("Inserire la descrizione, è un campo obbligatorio!");
          form.descrizione.focus();
          return false;
        }
        if(form.image.value == ""){
          alert("Selezionare un'immagine, è un campo obbligatorio!");
          form.image.focus();
          return false;
        }
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Aggiungi Foto</h2>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <FORM METHOD=POST action="/ecorent/Manager" name="myForm">
                              ...
                              <INPUT type="hidden" name="key" value="<c:out value="${foto.fk_oggetto}"/>">
                            </FORM>

                            <FORM ENCTYPE="multipart/form-data" METHOD=POST action="/ecorent/Uploader" name="myFormUp" onSubmit="return controlTextField(this);">
                            <INPUT type="hidden" name="Command" value="<c:out value="${Command}"/>">
                            <INPUT type="hidden" name="key" value="<c:out value="${foto.fk_oggetto}"/>">
                            <TABLE border="0" width="55%">
                              <TBODY>
                                <TR>
                                  <TD colspan="2" height="28" width="144">Oggetto</TD>
                                  <TD height="28" width="256"><INPUT type="TEXT" name="fk_obj"
                                    value="<c:out value="${foto.fk_oggetto}"/>" readonly></TD>
                                </TR>
                                <TR>
                                  <TD colspan="2" height="29" width="144">Numero</TD>
                                  <TD height="29" width="256"><INPUT type="TEXT" name="numero"
                                    value="<c:out value="${foto.numero}"/>" readonly></TD>
                                </TR>
                                <TR>
                                  <TD colspan="2" height="35" width="144">Descrizione</TD>
                                  <TD height="35" width="256"><INPUT type="TEXT" name="descrizione" value="<c:out value="${foto.descrizione}"/>"></TD>
                                </TR>
                                <TR>
                                  <TD colspan="2" width="144" height="36">Foto*</TD>
                                  <TD height="36" width="256"><INPUT type="FILE" name="image"></TD>
                                </TR>
                                <TR>
                                  <TD colspan="2" width="144" height="48"><INPUT type="submit"
                                    name="Submit" value="caricaFoto" class="btn btn-success"></TD>
