...
<head>
    ...
    <title>Eco-Rent - Guadagni per Categoria</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            ...
                            <a href="javascript:submitForm('ListEarningByCategory', '25')">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Categoria 25 km/h senza patente</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><c:out value="${earning25}"/> CHF</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-3 col-md-6 mb-4">
                          <div class="card border-left-primary shadow h-100 py-2">
                          <a href="javascript:submitForm('ListEarningByCategory', '30')">
                              <div class="card-body">
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                              Categoria 30 km/h con patente "M"</div>
                                          <div class="h5 mb-0 font-weight-bold text-gray-800"><c:out value="${earning30}"/> CHF</div>
                                      </div>
                                      <div class="col-auto">
                                          <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-3 col-md-6 mb-4">
                          <div class="card border-left-primary shadow h-100 py-2">
                          <a href="javascript:submitForm('ListEarningByCategory', '45')">
                              <div class="card-body">
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                              Categoria 45 km/h </div>
                                          <div class="h5 mb-0 font-weight-bold text-gray-800"><c:out value="${earning45}"/> CHF</div>
                                      </div>
                                      <div class="col-auto">
                                          <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                      </div>
