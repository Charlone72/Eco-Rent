...
<head>
    ...
    <title>Eco-Rent - Lista Manager</title>
    ...
    <script language="JavaScript">
      ...
      function listDocs(name) {
          ...
          document.myForm.Command.value = 'listDocs';
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                       <!-- Page Heading -->
                      <h1 class="h3 mb-2 text-gray-800"><c:out value="${titolo}"/></h1>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Riservazioni </h6>
                            <c:forEach var="row" items="${objects}">
                              <a href="javascript:viewObjectReservations('<c:out value="${row.key}"/>')"><c:out value="${row.nome} "/></a>
                            </c:forEach>
                            <c:if test="${Oggetto ne null}">
                              <div class="row">
                                <div class="col-md-2 col-sm-4 mb-2">
                                    <a href="javascript:submitForm('viewObject', '<c:out value="${Oggetto.key}"/>')">nome: <c:out value="${Oggetto.nome}"/></a>
                                </div>
                                <div class="col-md-2 col-sm-4 mb-2">
                                    key: <c:out value="${Oggetto.key}"/>
                                </div>
                              </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                              <FORM name="myForm" method="post" action="/ecorent/Manager">
                                ...
                                <INPUT type="hidden" name="tabella" value="riservazioni">
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${reservations}">
                                        <tr>
                                          ...
                                          <td><c:out value='${myFunc:showString(row.fk_utente, 15)}' escapeXml="false" /></td>
                                          <td><c:out value="${row.data_inizio}"/></td>
                                          <td><c:out value="${row.data_fine}"/></td>
                                          <td><c:out value="${row.days} - ${row.months} - "/><fmt:formatNumber type="number" pattern="###.## CHF" value="${row.price}" /></td>
                                          ...
                                          <td>
                                            <div class="dropdown">
                                              ...
                                              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                ...
                                                <li><a href="javascript:listDocs('<c:out value="${row.key}"/>');" class="dropdown-item">Lista Doc</a></li>
                                                <li role="separator" class="divider"></li>
