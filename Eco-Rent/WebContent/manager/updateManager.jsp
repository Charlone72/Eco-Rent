...
<head>
    ...
    <title>Eco-Rent - Aggiorna Manager</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Aggiorna Manager</h2>
                    </div>
                            ...
                            <FORM name="myForm" method="post" action="/ecorent/Manager">
                              ...
                              <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <input type="text" class="text" id="nome" name="nome" value="<c:out value="${manager.nome}"/> " readonly/>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                      <input type="text" class="text" id="password" name="password" value="<c:out value="${manager.password}"/>"/>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <input type="text" class="text" id="email" name="email" value="<c:out value="${manager.email}"/>"/>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                 ...
                                 <div class="row">
                                    <div class="col-md-3">
                                      <a href="javascript:submitForm('updateManager')" class="btn btn-success btn-icon-split">
                                          <span class="icon text-white-50">
                                              <i class="fas fa-check"></i>
                                          </span>
                                          <span class="text">Aggiorna Manager</span>
                                      </a>
                                    </div>
                                  </div>
                              </div>
