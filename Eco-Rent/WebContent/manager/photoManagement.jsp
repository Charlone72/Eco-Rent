...
<head>
    ...
    <title>Eco-Rent - Gestione foto</title>
    ...
    <script language="JavaScript">
      ...
      function modificaFoto(param) {
          myForm.Command.value = 'viewUpdatePhoto';
          myForm.selezione.value = param;
          myForm.submit();

        }

        function eliminaFoto(param) {
          myForm.Command.value = 'deletePhoto';
          myForm.selezione.value = param;
          myForm.submit();
        ...
        function nuovaFoto() {
            myForm.Command.value = 'preparePhoto';
            myForm.selezione.value = '';
            myForm.submit();
        }
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Gestione Foto</h2>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Scooter <c:out value="${Oggetto.key}"/></h6>
                        </div>
                        <div class="card-body">
                    ...
                    <c:if test="${not empty foto.listaFoto}">
                      <c:forEach var="row" items="${foto.listaFoto}" varStatus="loopCounter">
                           ...
                           <div class="row">
                             <div class="col-md-2 col-sm-4 mb-4">
                                <IMG class="img-fluid" src="<c:out value="${url}"/>" width="130" height="97" style="border: gray solid 1px" alt="<c:out value="${row.descrizione}"/>">
                             </div>
                             <div class="col-md-2 col-sm-4 mb-4">
                                <div><c:out value="${row.numero}"/></div>
                                <div><c:out value="${row.descrizione}"/></div>
                             </div>
                             <div class="col-md-2 col-sm-4 mb-4">
                                <div><button type="button" class="btn btn-info" onclick="javascript:modificaFoto('<c:out value="${row.numero}"/>')">
                                 <span class="btn-label"><i class="fa fa-edit"></i></span> Modifica</button></div>
                                <div><button type="button" class="btn btn-danger" onclick="javascript:eliminaFoto('<c:out value="${row.numero}"/>')">
                                 <span class="btn-label"><i class="fa fa-trash"></i></span> Elimina</button></div>
                             </div>
                          </div>
                      </c:forEach>
                    </c:if>
                      ...
                      <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 mb-4">
                              <button type="button" class="btn btn-success" onclick="javascript:nuovaFoto()">
                                <span class="glyphicon glyphicon-search"></span>Nuova foto
                              </button>
                            </div>
