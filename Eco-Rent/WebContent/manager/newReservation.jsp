...
<body id="page-top">
                            ...
                            <FORM name="myForm" method="post" action="/ecorent/Manager">
                              ...
                              <INPUT type="hidden" name="key" value="">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <!-- <input type="text" class="text" id="fk_utente" name="fk_utente" />-->
                                      <select name="fk_utente" class="select">
                                         <c:forEach var="row" items="${users}">
                                           <option value="<c:out value="${row.email}"/>" ><c:out value="${row.nome}"/> - <c:out value="${row.cognome}"/></option>
                                         </c:forEach>
                                      </select>
                                    </div>
                                 </div>
    ...
    <script>
      ...
      var emails = [<c:forEach var="row" items="${users}" varStatus="loop"><c:if test="${loop.index ne 0}">,</c:if><c:out value="'${row.email}'" escapeXml="false"/></c:forEach>];
