...
<head>
    ...
    <title>Eco-Rent - view Reservation</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span>Dettagli Riservazione</span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Dettaglio Riservazione</h2>
                    </div>
                            ...
                            <FORM name="myForm" method="post" action="/ecorent/Manager">
                              ...
                              <INPUT type="hidden" name="key" value="<c:out value="${Riservazione.key}" />">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.key}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.fk_oggetto}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.fk_utente}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <select name="stato" class="select" readonly>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><fmt:formatDate pattern = "dd-MM-yyyy" value = "${Riservazione.data_inizio}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><fmt:formatDate pattern = "dd-MM-yyyy" value = "${Riservazione.data_fine}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.final_price}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.metodo_pagamento}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.fattura_num}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.da_km}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.a_km}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.procurato}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.note}" /></label>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-6 col-sm-4">
                                    ...
                                    <div class="col-6 col-sm-4">
                                      <label><c:out value="${Riservazione.data_pagamento}" /></label>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-2">
                                      <button class="btn btn-success" onclick="javascript:submitForm('viewUpdateReservation')">
                                          Update
                                      </button>
                                    </div>
                                 </div>
