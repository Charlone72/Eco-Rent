...
<head>
    ...
    <title>Eco-Rent - New Scooter</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Aggiungi Scooter</h2>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Scooter</h6>
                        </div>
                        <div class="card-body">

                            <FORM name="myForm" method="post" action="/ecorent/Manager">
                              <INPUT type="hidden" name="Command" value="insertObject">
                              <div class="container">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <INPUT type="text" size="32" name="nome" value="">
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <INPUT type="text" name="tipo" size="32" value="">
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                      <TEXTAREA rows="3" cols="30" name="descrizione"></TEXTAREA>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                      <TEXTAREA rows="3" cols="30" name="specifiche"></TEXTAREA>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                      <TEXTAREA rows="3" cols="30" name="varie"></TEXTAREA>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                      <INPUT type="text" name="anno" size="4" value="">
                                    </div>
                                 </div>
                                 <div class="row">
                                   <div class="col-md-2">
                                   ...
                                   <div class="col-md-2">
                                      <select name="funzionante" class="select">
                                           <option value="true">Funzionante</option>
                                           <option value="false">Non funzionante</option>
                                      </select>
                                   </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-3">
                                      <a href="javascript:submitForm('insertObject')" class="btn btn-success btn-icon-split">
                                          <span class="icon text-white-50">
                                              <i class="fas fa-check"></i>
                                          </span>
                                          <span class="text">Aggiungi Scooter</span>
                                      </a>
                                    </div>
                                 </div>
                              </div>
