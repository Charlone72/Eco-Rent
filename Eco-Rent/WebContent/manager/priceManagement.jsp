...
<head>
    ...
    <title>Eco-Rent - Gestione prezzi</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Gestione Prezzi</h2>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Scooter <a href="javascript:submitForm('viewObject')"><c:out value="${oggetto.nome}"/></a></h6>
                        </div>
                        <div class="card-body">
                          ...
                          <FORM name="myForm" method="post" action="/ecorent/Manager">
                            ...
                            <div class="row">
                               <div class="col-md-4">
                                 <h5>Prezzi settimanali:</h5>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>1 giorno:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="g1" name="g1" value="<c:out value="${prezzi.g1}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>2 giorni:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="g2" name="g2" value="<c:out value="${prezzi.g2}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>3 giorni:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="g3" name="g3" value="<c:out value="${prezzi.g3}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>4 giorni:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="g4" name="g4" value="<c:out value="${prezzi.g4}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>5 giorni:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="g5" name="g5" value="<c:out value="${prezzi.g5}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>6 giorni:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="g6" name="g6" value="<c:out value="${prezzi.g6}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>Una settimana:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="g7" name="g7" value="<c:out value="${prezzi.g7}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>Giorni supplementari:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="more_g" name="more_g" value="<c:out value="${prezzi.more_g}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-4">
                                 <h5>Prezzi mensili:</h5>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m1" name="m1" value="<c:out value="${prezzi.m1}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m2" name="m2" value="<c:out value="${prezzi.m2}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m3" name="m3" value="<c:out value="${prezzi.m3}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m4" name="m4" value="<c:out value="${prezzi.m4}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m5" name="m5" value="<c:out value="${prezzi.m5}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m6" name="m6" value="<c:out value="${prezzi.m6}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m7" name="m7" value="<c:out value="${prezzi.m7}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m8" name="m8" value="<c:out value="${prezzi.m8}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m9" name="m9" value="<c:out value="${prezzi.m9}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m10" name="m10" value="<c:out value="${prezzi.m10}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m11" name="m11" value="<c:out value="${prezzi.m11}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <input type="text" class="text" id="m12" name="m12" value="<c:out value="${prezzi.m12}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <label>Mesi supplementari:</label>
                               </div>
                               <div class="col-md-2">
                                 <input type="text" class="text" id="more_m" name="more_m" value="<c:out value="${prezzi.more_m}"/>"/>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-2">
                                 <button type="submit" class="btn btn-info" onclick="javascript:submitForm('<c:out value="${command}"/>')">
                                     <span class="glyphicon glyphicon-search"></span> <c:out value="${command}"/>
                                 </button>
                               </div>
                               <div class="col-md-2">
                                 <button type="submit" class="btn btn-info" onclick="javascript:submitForm('copyPrice')">
                                     <span class="glyphicon glyphicon-search"></span> Copia prezzi
                                 </button>
                               </div>
                               <c:if test="${prices ne null}">
                                 <div class="col-md-2">
                                   <button type="submit" class="btn btn-info" onclick="javascript:submitForm('pastePrice')">
                                       <span class="glyphicon glyphicon-search"></span> Incolla prezzi
                                   </button>
                                 </div>
                               </c:if>
                            </div>
