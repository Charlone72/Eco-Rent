...
<head>
    ...
    <title>Eco-Rent - upload documento</title>
    ...
    function padreDocs(value, fk_tabella, tabella) {

        document.myForm.Command.value = value;
        document.myForm.fk_tabella.value = fk_tabella;
        document.myForm.tabella.value = tabella;

        myForm.submit();
    }

    function controlTextField(form) {
        if(form.dataDocumento.value == ""){
          alert("Inserire la data , è un campo obbligatorio!");
          form.dataDocumento.focus();
          return false;
        }
        if(form.tipo.value == ""){
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span>Aggiungi Documento</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Aggiungi Documento</h2>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Documento - Tabella: <c:out value="${Documento.tabella}"/></h6>
                        </div>
                        <div class="card-body">
                            ...
                            <c:when test="${Documento.tipo eq ''}">
                              ...
                              <TABLE border="0" width="55%">
                                <TBODY>
                                    ...
                                    <TD height="35" width="256">
                                      ...
                                      <div class="form-group">
                                          <div class='input-group date' id='datepicker'  data-date-format="dd-mm-yyyy">
                                              <input type='text' class="form-control" name='dataDocumento'/>
                                      ...
                                      <!--  <div id="datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
                                        <input class="form-control" name="dataDocumento" type="text"  />
                                  ...
                                  <TR>
                                    <TD colspan="2" width="144" height="36">Tabella</TD>
                                    <TD height="36" width="256"><INPUT type="TEXT" name="tabella" value="<c:out value="${Documento.tabella}"/>" readonly></TD>
                                  </TR>
                                  <TR>
                                    <TD colspan="2" width="144" height="36">FK_Tabella</TD>
                                    <TD height="36" width="256"><INPUT type="TEXT" name="fk_tabella" value="<c:out value="${Documento.fk_tabella}"/>" readonly></TD>
                                  </TR>
                                  <TR>
                              ...
                              <TABLE border="0" width="55%">
                                <TBODY>
                                  ...
                                  <TR>
                                    <TD colspan="2" height="35" width="144">Data</TD>
                                    <TD height="35" width="256">
                                      <input id="datepicker" width="276" name='dataDocumento' data-date-format="dd-mm-yyyy"/>
                                      <!--<div id="datepicker" class="input-group date" data-date-format="dd-mm-yyyy" value="<c:out value="${Documento.dataDocumento}"/>">
                                        <input class="form-control" name="dataDocumento" type="text"  />
                                        <span class="fa fa-calendar input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                      </div>-->
                                  ...
                                  <!--<TR>
                                    ...
                                    <INPUT type="TEXT" name="tabella" value="">
                                     <select name="tabella" class="select">
                                         <option value="oggetti" <c:out value="${myFunc:isSelected(Documento.tabella, 'oggetti')}"/>>oggetti(scooter)</option>
                                         <option value="oggetti_venduti" <c:out value="${myFunc:isSelected(Documento.tabella, 'oggetti_venduti')}"/>>oggetti_venduti(scooter)</option>
                                         <option value="riservazioni" <c:out value="${myFunc:isSelected(Documento.tabella, 'riservazioni')}"/>>riservazioni</option>
                                      </select>
                                    </TD>
                                  </TR>-->
                                  <TR>
            ...
            <div class="col-lg-12">
              ...
              <FORM name="myForm" method="post" action="/ecorent/Manager">
                  <INPUT type="hidden" name="Command" value="listDocs">
                  <INPUT type="hidden" name="key" value="<c:out value="${Documento.fk_tabella}"/>"/><!-- serve per l'eliminazione di un doc -->
                  <INPUT type="hidden" name="fk_tabella" value="<c:out value="${Documento.fk_tabella}"/>"/>
                  <INPUT type="hidden" name="tabella" value="<c:out value="${Documento.tabella}"/>"/>
              </FORM>
              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      ...
                      <a href="javascript:padreDocs('padreDocs', '<c:out value="${Documento.fk_tabella}"/>', '<c:out value="${Documento.tabella}"/>')" class="btn btn-success btn-icon-split">
                          <span class="text">Padre documenti</span>
                      </a>
                      <div class="my-2"></div>
                  </div>
              </div>
    ...
    <script>
      <c:choose>
        <c:when test="${Documento ne null}">

          var date = '<fmt:formatDate pattern = "dd-MM-yyyy" value = "${Documento.dataDocumento}" />';
        </c:when>
        <c:otherwise>
          var date = new Date();
        </c:otherwise>
