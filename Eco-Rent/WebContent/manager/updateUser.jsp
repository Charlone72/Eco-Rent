...
<head>
    ...
    <title>Eco-Rent - aggiorna Utente</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Aggiorna Utente</h2>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <FORM name="myForm" method="post" action="/ecorent/Manager">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="nome" name="nome" value="<c:out value="${Utente.nome}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="cognome" name="cognome" value="<c:out value="${Utente.cognome}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="email" name="email" value="<c:out value="${Utente.email}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="domicilio" name="domicilio" value="<c:out value="${Utente.domicilio}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="cap" name="cap" value="<c:out value="${Utente.cap}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="via" name="via" value="<c:out value="${Utente.via}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="telefono" name="telefono" value="<c:out value="${Utente.telefono}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="password" name="password" value="<c:out value="${Utente.password}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                  <div class="col-md-2">
                                  ...
                                  <div class="col-md-2">
                                    <input type="text" class="text" id="enabled" name="enabled" value="<c:out value="${Utente.enabled}" />" />
                                  </div>
                               </div>
                               <div class="row">
                                    <div class="col-md-3">
                                      <a href="javascript:submitForm('updateUserOk')" class="btn btn-success btn-icon-split">
                                          <span class="icon text-white-50">
                                              <i class="fas fa-check"></i>
                                          </span>
                                          <span class="text">Aggiorna Utente</span>
                                      </a>
                                    </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      <div class="my-2"></div>
                      <a href="javascript:submitFormMenu('userList')" class="btn btn-success btn-icon-split">
                          <span class="text">Lista Utenti</span>
                      </a>
                      <div class="my-2"></div>
                  </div>
              </div>
