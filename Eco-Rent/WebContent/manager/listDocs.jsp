...
<head>
    ...
    <title>Eco-Rent - Gestione documenti</title>
    ...
    <script language="JavaScript">
      ...
      function addDoc(value, fk_tabella, tabella) {
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span>Gestione Documenti</span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Lista Documenti</h2>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <FORM name="myForm" method="post" action="/ecorent/Manager">
                              ...
                              <INPUT type="hidden" name="fk_tabella" value="<c:out value="${FK_Tabella}"/>"><!-- serve per l'eliminazione di un doc -->
                              <INPUT type="hidden" name="tabella" value="<c:out value="${Tabella}"/>">
                              ...
                              <c:forEach var="row" items="${Documenti}">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-1 col-sm-2 mb-2">
                                    <c:out value="${row.tabella}"/>
                                  </div>
                                  <div class="col-md-1 col-sm-2 mb-2">
                                    <c:out value="${row.fk_tabella}"/>
                                  </div>
                                  <div class="col-md-2 col-sm-4 mb-4">
                                    <c:out value="${row.tipo}"/>
                                  </div>
                                  <div class="col-md-2 col-sm-4 mb-4">
                                    <c:out value="${row.dataDocumento}"/>
                                  </div>
                                  <div class="col-md-1 col-sm-2 mb-2">
                                    <button type="button" class="btn btn-danger" name="deleteDoc" onclick="javascript:submitForm('deleteDoc', '<c:out value="${row.key}"/>');">
                                      Elimina
                                    </button>
                                  </div>
                                  <div class="col-md-1 col-sm-2 mb-2">
                                    <button type="button" class="btn btn-success" name="updateDoc" onclick="javascript:submitForm('uploadPdfUpdate', '<c:out value="${row.key}"/>');">
                                      Aggiorna
                                    </button>
                                  </div>
                                </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      ...
                      <a href="javascript:addDoc('uploadPdf', '<c:out value="${FK_Tabella}"/>', '<c:out value="${Tabella}"/>')" class="btn btn-success btn-icon-split">
                          <span class="text">Aggiungi documento</span>
                      </a>
                      <a href="javascript:padreDocs('padreDocs', '<c:out value="${FK_Tabella}"/>', '<c:out value="${Tabella}"/>')" class="btn btn-success btn-icon-split">
