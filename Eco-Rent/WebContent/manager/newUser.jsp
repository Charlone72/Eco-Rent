...
<head>
    ...
    <title>Eco-Rent - add Utente</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Aggiungi Utente</h2>
                    </div>
                            ...
                            <FORM name="myForm" method="post" action="/ecorent/Manager">
                              ...
                              <div class="container">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <input type="text" class="text" id="domicilio" name="domicilio" value="" />
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                      <input type="text" class="text" id="cognome" name="cognome" value="" />
                                    </div>
                                    <div class="col-md-2">
                                      <label>Cap:</label>
                                    </div>
                                    <div class="col-md-2">
                                      <input type="text" class="text" id="cap" name="cap" value="" />
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                      <input type="text" class="text" id="via" name="via" value="" />
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                      <input type="text" class="text" id="telefono" name="telefono" value="" />
                                    </div>
                                    <div class="col-md-2">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-3">
                                      <input type="text" class="text" id="enabled" name="enabled" value="" />
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-3">
                                      <a href="javascript:submitForm('createUser')" class="btn btn-success btn-icon-split">
