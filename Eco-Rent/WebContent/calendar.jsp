...
<html lang="<c:out value='${sessionScope.lang}'/>">
<head>
  <meta name="description" content="eco-rent calendar, rent scooter, noleggio scooter, affitto scooter">
  <meta name="author" content="eco-rent">
  <title>EcoRent - calendar</title>
  <meta charset="utf-8">
  ...
  <script src="./js/bootstrap-year-calendar.de.js"></script>
  <script src="./js/bootstrap-year-calendar.fr.js"></script>
  <script src="./js/bootstrap-year-calendar.it.js"></script>
  ...
  <script src="./js/scripts.js"></script>
    ...
    <script>
      ...
      function editEvent(event) {
        ...
        $('#event-modal input[name="event-start-date"]').datepicker({ format: 'dd/mm/yyyy', autoclose: true });
        $('#event-modal input[name="event-end-date"]').datepicker({ format: 'dd/mm/yyyy', autoclose: true });
...
<c:if test="${utente eq null}">
      ...
      $(function() {
          ...
          $('#calendar').calendar({
              ...
              autoclose: true,
              allowOverlap: false,
              language: "<c:out value='${sessionScope.lang}'/>",
              style:'background',
...
<body>
  ...
  <div id="wrap">
      ...
      <div class="container">
        ...
        <h3><fmt:message key="calendar.calendar" /></h3>
        <p><fmt:message key="calendar.title" /> <c:out value="${Oggetto.nome}"/></p>
        <div id="calendar"></div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only"><fmt:message key="calendar.close" /></span></button>
...
<c:choose>
    ...
    <c:otherwise>
                  ...
                  <div class="form-group">
                    <label for="min-date" class="col-sm-4 control-label"><fmt:message key="calendar.dates" /></label>
                    <div class="col-sm-7">
                      <div class="input-group input-daterange" data-provide="datepicker">
                        <input name="event-start-date" type="text" class="form-control" value="2019-04-05">
                        <span class="input-group-addon"><fmt:message key="calendar.dataTo" /></span>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message key="calendar.cancel" /></button>
...
<c:choose>
    ...
    <c:otherwise>
              <INPUT type="hidden" name="Command" value="showInfoRiservazione">
              <INPUT type="hidden" name="fk_utente" value="">
    </c:otherwise>
</c:choose>
